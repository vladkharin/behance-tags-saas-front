...
export const AuthForm: React.FC<AuthFormProps> = ({ onNavigatePrivacy, onNavigateTerms }) => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-behance-grayBg dark:bg-behance-darkBg px-4 transition-colors duration-500">
      ...
      <div className="w-full max-w-[400px] bg-white dark:bg-behance-darkCard border border-behance-border dark:border-white/5 rounded-2xl p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] dark:shadow-2xl transition-colors duration-500">
          ...
          {!isLoginMode && (
            <div className="flex items-start gap-3 mt-4 text-left">
              ...
              <label htmlFor="agreement" className="text-[11px] leading-relaxed text-behance-muted dark:text-gray-400 select-none">
                ...
                <button type="button" onClick={onNavigateTerms} className="text-behance-blue hover:underline font-medium transition-all cursor-pointer">
                  {t("auth.agreementOffer")}
                </button>
                {" "}{t("auth.agreementAnd")}{" "}
                <button type="button" onClick={onNavigatePrivacy} className="text-behance-blue hover:underline font-medium transition-all cursor-pointer">
